...
const pages = ['شگفت انگیز ها', 'سوپر مارکت', 'کارت هدیه','تخفیف وپیشنهاد ها','پر فروش ترین ها','  سوالی دارید؟','!در دیجیکالا بقروشید'];
          ...
          <Button
            ...
            {pages.map((page) => (
              <Button
                key={page}
                onClick={handleCloseNavMenu}
                sx={{ my: 2, color: "#616161", display: 'block',my: 2, 
                fontWeight: 600,
                fontsize: "12px",
                display: "flex",
                alignItems: "center",
